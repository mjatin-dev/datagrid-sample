...
export default function CreateUser({ handleClose, open, data }) {
  ...
  const createUser = () => {
    ...
    if (validateForm(error)) {
      ...
      formData.append("customer_id", companyId);
      try {
        axiosInstance
          ...
          <div className="row my-3">
            ...
            <div className="col-6">
              ...
              <CreatableSelect
                ...
                value={{
                  label: fields?.expertise || "select or type expertise",
                  value: fields?.expertise || "select or type expertise",
                }}
          ...
          <div className="row mb-3">
            <div className="col-6">
              ...
              <CreatableSelect
                ...
                value={{
                  label: fields?.company || "select company",
                  value: fields?.company || "select company",
                }}
