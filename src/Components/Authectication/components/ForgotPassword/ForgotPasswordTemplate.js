...
export const getTemplate = (email) => {
    const link = `http://139.162.5.110:9091/#/change-password?email=${email}`;
    let templateStr = `<!DOCTYPE html>
    <html>
        <head>
            <meta name="viewport" content="width=device-width" />
            <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
            <title>Reset your CAPMTech Account password</title>
        ...
        <body style="max-width: 680px; width: 680px; font-family: Poppins,Arial; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
            <table
                ...
                cellspacing="0"
                class=""
                style="background-color: #f6f8fb; width: 100%; border: 1px solid #e0e0e0; border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;"
            >
                <tr>
                    <td style="display: block; margin: 0 auto !important; max-width: 680px; width: 680px; font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        <div
                            style="
                            ...
                            "
                        >
                            <table role="presentation" style="border-radius: 3px; width: 100%;">
                                <tr>
                                    <td style="box-sizing: border-box; padding: 0 70px; font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <p
                                                                                        ...
                                                                                        "
                                                                                    >
                                                                                        Reset your CAPMTech<br/> Account password
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td align="center">
                                                                                    <p
                                                                                        ...
                                                                                        "
                                                                                    >
                                                                                        We are sending you this email as you have requested a password reset. Click the reset button down below to create a new password 
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td align="center">
                                                                                    <p
                                                                                        ...
                                                                                        "
                                                                                    >
                                                                                        If you did not initiate this request, please get back to us<br/> immediately at <a href="" style="color: #fbff91;font-weight: 500;text-decoration: none;">reachus@secmark.in</a> 
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                             <tr>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td
                                                                                    ...
                                                                                    "
                                                                                >
                                                                                    <a href="https://www.google.com/url?q=https://drive.google.com/file/d/1eV8wzPYFN4s9KxTA2oQCoQjEM2s8vDU-/view&sa=D&source=hangouts&ust=1621405012282000&usg=AFQjCNEnO5aGXqg2srJnDZqxcuxzwbKQVg" target="_blank" style="color: #9a9ea2; text-decoration: none;">Terms & Conditions</a>
                                                                                </td>
                                                                                <td
                                                                                    align="center"
                                                                                    style="
