...
import LicenseTaskList from "../../OnBoarding/SubModules/DashBoardCO/components/DashBoardView/component/LicenseTaskList";
import CompanyTaskList from "../../OnBoarding/SubModules/DashBoardCO/components/DashBoardView/component/companyList";
import AssignedView from "../../OnBoarding/SubModules/DashBoardCO/components/DashBoardView/component/AssignedView";
        ...
        <div className="ER-detail-name align-left-always col-2">
          <p>
            <span className="circle-dp">
              {getInitialName(filterdList.ApproverName)}
            </span>{" "}
