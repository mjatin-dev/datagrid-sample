    ...
    <div>
      ...
      <div className="Rectangle" id="res">
        ...
        <div className="options-list">
          ...
          <div
            id="res3"
            onClick={() => selectProfileOption("tasklist")}
            className={options === "tasklist" && "activation-3"}
          >
            <div className="getoption-3">Task List</div>
          </div>
          <div className="rectangle_1">
            <div className="underText">
              The projects automaticaly remove from Trash after 30 days{" "}
            </div>
          </div>
