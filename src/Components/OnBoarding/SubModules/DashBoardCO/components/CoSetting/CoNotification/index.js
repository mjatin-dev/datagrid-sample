  ...
  const changeSettingFlags = (type, isEnable) => {
    switch (type) {
      ...
      case "SMS":
        ...
        break;
      case "Monthly":
        setMonthlyChecked(isEnable === 0 ? false : true);
        break;
      case "Weekly":
        setWeeklyChecked(isEnable === 0 ? false : true);
        break;
    }
  };
  ...
  const onSliderChange = (e, type) => {
    ...
    switch (type) {
      ...
      case "SMS":
        ...
        break;
      case "Monthly":
        setMonthlyChecked(!isMonthlyChecked);
        break;
      case "Weekly":
        setWeeklyChecked(!isWeeklyChecked);
        break;
    }
  };
            ...
            <div className="col-9">
              <div className="notification-div">
                ...
                <p className="normal-text">
                  You'll receive all Compliance Sutra notifications on your
                  registered email
                </p>
              </div>
            </div>
          ...
          <div className="row mar-bottom">
            <div className="col-9">
              <div className="notification-div">
                ...
                <p className="normal-text">
                  You'll receive all Compliance Sutra notifications via sms on
          ...
          <div className="row mar-bottom">
            <div className="col-9">
              <div className="notification-div">
                ...
                <p className="normal-text">
                  You'll receive monthly reports on your preferred email id
                </p>
              </div>
            </div>
            <div className="col-3">
              <div className="check-box">
                <label className="switch" id="monthly">
                  <input
                    ...
                    onClick={(e) => onSliderChange(e, "Monthly")}
                  />
                  <span className="slider round"></span>
                </label>
              </div>
          ...
          <div className="row mar-bottom">
            <div className="col-9">
              <div className="notification-div">
                ...
                <p className="normal-text">
                  You'll receive weekly reports every Monday on your preferred
                  email id
                </p>
              </div>
            </div>
              ...
              <div className="check-box">
                <label className="switch" id="weekly">
                  <input
                    ...
                    onChange={(e) => onSliderChange(e, "Weekly")}
                  />
                  <span className="slider round"></span>
                </label>
              </div>
