            ...
            <div className="all-companies-task-grid-1 co-history">
              <div class="right-side">
                ...
                <div class="desc-title">
                  Search for all your tasks here, lorem ipsum dolor smit amet,
                </div>
                <div className="form-div">
                  <form>
                    ...
                    <div class="form-group pos-rel">
                      ...
                      <input
                        value="B&K Securities"
                        type="text"
                        class="form-control"
                        id="Company"
                        placeholder="B&K Securities"
                      />
          ...
          <div className="all-companies-task-grid mobile-dashboard-view">
            <div className="mobile-height-dasboardView">
              ...
              <div className="result-data">
                <div className="row border-btm-head">
                  ...
                  <div className="col-md-2">
                    <p className="table-head"> Assign To </p>
                  </div>
                  <div className="col-md-2">
                ...
                <div className="row border-btm">
                  ...
                  <div className="col-md-2">
                    <p className="assign-label-name">
                      {" "}
                      <span className="asign-circle">BK</span>Bharat Kedia{" "}
                    </p>
                  </div>
                  <div className="col-md-2">
                    <p className="date-label">02 Jan 2021</p>
                ...
                <div className="row border-btm">
                  ...
                  <div className="col-md-3">
                    <p className="task-name-label">
                      Enhanced supervision reporting of Filing the Report{" "}
                    </p>
                  </div>
                  <div className="col-md-2">
                    <p className="assign-label-name">
              ...
              <div className="d-flex pl-0">
                <div className="overview-mobile d-block d-sm-none">
                  Overview
                </div>
