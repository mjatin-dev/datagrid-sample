...
import { getDayData } from "Components/CalenderView/redux/actions";
import reducer from "Components/ReAssignTasks/reducer";
// import reducer from "Components/ReAssignTasks/reducer";
import "Components/ReAssignTasks/style.css";
function BulkReAssignTasksModal({
  openModal,
  setShowModal,
  userType,
  userId,
  ...
  return (
    <Modal
      ...
      onClose={handleClose}
      classNames={{
        modalContainer: "customReAssignModalContainerMobile bulk-comment-form full-w",
        modal: "customReAssignModalMobile bulk-comment-form full-w",
      }}
      ...
      <div className="re-container">
        {Object.entries(assignTo).length === 0 && (
          <div className="modal-top">
            <h5 className="modal-title">{titleName(tab)}</h5>
        ...
        <div className="header">
          {Object.entries(assignTo).length === 0 && (
            <div className="header-controls">
              <div style={{fontSize:12,marginBottom:5}}>Enter name or email</div>
              <input
                type="text"
        ...
        <div className="main-content">
          {Object.entries(assignTo).length === 0 && (
            ...
            >
              ...
              0 ? ( searchUsers(debouncedSearchValue, memberList || data).map(
                  (member, index) => {
                    const { email, full_name } = member;
                    return (
                      <div className="member-style" 
                        // onClick={()=>handleAction('confirm',email)}
                      >
                        <div
                          className="member-sub-style"
                          key={index}
                          onClick={()=>handleAction('confirm',member)}
                    ...
                    >
                      ...
                      {(searchValue !== "" && validator.isEmail(searchValue)) ? (
                        <div className="dropbox-add-line"
                            onClick={() => {
                              handleAction('confirm',searchValue);
                      ...
                      ) : <div className="dropbox-add-line" style={{cursor:'not-allowed'}}>
                          No Records Found
                        </div>}
                    </span>
...
export default BulkReAssignTasksModal;
