...
import reducer from "Components/ReassignTaskToUser/reducer";
...
import {
  ...
  searchUsers,
} from "Components/ReassignTaskToUser/utilties";
...
import "Components/ReassignTaskToUser/style.css";

function BulkReAssignTasksToUserModal({
  openModal,
  setShowModal,
  userId,
  isSingleTask,
  ...
  const [isEmailValidationLoading, setIsEmailValidationLoading] = useState(false);
  ...
  useEffect(() => {
    console.log("Effect: ",isSingleTask);
...
export default BulkReAssignTasksToUserModal;
