...
function RightSideGrid({
                  ...
                  <div className="closing-icon">
                    ...
                    <div
                      ...
                      onClick={() => {
                        ...
                        dispatch(adminMenuActions.setIsModalOpen(""));
                        if (history.location?.state?.handleBack) {
                          history.goBack();
                          const from = history.location?.state?.from;
                          if (from) {
                            // dispatch(adminMenuActions)
                            dispatch(adminMenuActions.setCurrentMenu(from));
                          }
                        }
                      }}
                    >
                    ...
                    {/* {completedDate &&
                      ...
                      userDetails.UserType !== 4 && (
                        <div className="row">
                          ...
                          <div className="col-8 col-sm-9 col-md-9 col-xl-9">
                            <div className="holding-list-bold-title">
                              {moment(completedDate).format("DD MMM  hh:mm A")}
                            </div>
                          </div>
                        </div>
                      )} */}
                ...
                <div>
                    ...
                    <div className="d-flex">
                      ...
                      <div className="tab-list-space">
                        {referenceShow ? (
                          ...
                          >
                            {currentOpenedTask?.customer_name ===
                            "Internal Task"
                              ? "Description"
                              : "References"}
                          </div>
                  ...
                  {referenceShow && (
                    <>
                      ...
                      {currentOpenedTask?.customer_name === "Internal Task" ? (
                        <TaskDescriptionTab />
                      ) : (
                        <TaskReferencesTab />
                      )}
                      ...
                      {currentOpenedTask &&
                        ...
                        (currentOpenedTask.customer_name === "Internal Task"
                          ? user.email === currentOpenedTask.approver ||
                            user.email === currentOpenedTask.task_owner
                          : user.UserType === 3 ||
                            user.email === currentOpenedTask.approver) && (
                              ...
                              <div className="rigt-box-comment">
                                <div className="d-flex">
                                  ...
                                  <div className="days-ago">
                                    {moment(comment.commented_on).format("lll")}
                                  </div>
                                </div>
                            ...
                            <div className="rigt-box-comment">
                              <div className="input-comment-box input-comment-boxLeft">
                                <TextareaAutosize
                                  ...
                                  required
                                  onBlur={(e) => {
                                    setInputComment(e.target?.value?.trim());
                                  }}
                                />
  ...
  const handleChange = (e) => {
    setInputComment(sanitizeInput(String(e.target.value)));
  };
  ...
  const renderSidebarTaskList = (task, Status, listType) => {
    return (
      <div
        ...
        style={{ cursor: "pointer" }}
        key={`sidebar-task-${task?.task_name}`}
      >
        ...
        <div className="all-companies-task-grid mobile-dashboard-view">
          ...
          {currentTab === "Tasks" ? (
            <>
                      ...
                      {(user ? user.UserType !== 4 : "") && (
                        <span
                          className={
                            ...
                            displayTask === "List" || displayTask === "Board"
              ...
              {searchValue === "" && isMobile && displayTask === "List" && (
                <>
                  <div
              ...
              {false && displayTask === "Board" && searchValue === "" && (
                ...
                style={
                  userDetails.UserType === 4
                    ? isMobile
                      ...
                      : { maxHeight: "calc(100vh - 375px)", width: "100%" }
                    : { maxHeight: "calc(100vh - 260px)", width: "100%" }
                }
                onScroll={() => {
            ...
            >
              <div className="all-companies-task-grid-2 inside-padding-sidebar">
                ...
                <div className="take-action">
                  ...
                  {searchValue === "" && taskListDisplay === "company" && (
                    <>
                      <CompanyTaskList
                        user={user}
                  ...
                  {searchValue === "" && taskListDisplay === "license" && (
                    <LicenseTaskList
                      user={user}
                      sideBarTaskList={true}
                      currentOpenedTask={currentOpenedTask}
                  ...
                  {searchValue === "" && taskListDisplay === "team-member" && (
                    <AssigneList
                      user={user}
                      sideBarTaskList={true}
                      currentOpenedTask={currentOpenedTask}
                            ...
                            <div className="input-comment-box input-comment-boxLeft">
                              ...
                              <div className="inputIcon">
                                <img
                                  ...
                                  style={{
                                    cursor: "pointer",
                                    ...(removeOnlySpaces(inputComment) ===
                                      "" && { opacity: "0.6" }),
                                  }}
                                  onClick={() => {
                                    if (removeOnlySpaces(inputComment) !== "")
                                      submitComment();
                                  }}
                                />
                              </div>
