...
const FirstLastName = ({ index, setInputs, deleteInputs, data }) => {
  ...
  const setDescription = (editorState) => {
    ...
    setInputs(htmlData, index, "firstLastName", "description");
    setEditorState(editorState);
  };

  const setValues = (event) => {
    setTextField(event.target.value);
    setInputs(event.target.value, index, "firstLastName");
  };
  ...
  return (
    <div>
      <p className="short-answer-p">First / Last Name</p>
        ...
        >
          <select
            ...
            onChange={(event) => {
              ...
              setInputs(temp, index, "firstLastName", "responseValidation");
            }}
          >
            <option></option>
          ...
          <img
            ...
            onClick={() => {
              ...
              setInputs({}, index, "firstLastName", "responseValidation");
            }}
          />
        </div>
      )}
