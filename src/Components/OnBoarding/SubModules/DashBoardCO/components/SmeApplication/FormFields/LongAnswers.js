...
const LongAnswer = ({ index, setInputs, deleteInputs, data }) => {
  ...
  const setDescription = (editorState) => {
    ...
    setInputs(htmlData, index, "longanswer", "description");
    setEditorState(editorState);
  };

  const setValues = (event) => {
    setTextField(event.target.value);
    setInputs(event.target.value, index, "longanswer");
  };

  return (
    <div>
      <p className="short-answer-p">Long Answer</p>
        ...
        >
          <select
            ...
            onChange={(event) => {
              ...
              setInputs(temp, index, "longanswer", "responseValidation");
            }}
          >
            <option></option>
          ...
          <img
            ...
            onClick={() => {
              ...
              setInputs({}, index, "longanswer", "responseValidation");
            }}
          />
        </div>
      )}
