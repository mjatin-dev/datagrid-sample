...
const PAN = ({ index, setInputs, deleteInputs, data }) => {
  ...
  const setDescription = (editorState) => {
    ...
    setInputs(htmlData, index, "PAN", "description");
    setEditorState(editorState);
  };

  const setValues = (event) => {
    setTextField(event.target.value);
    setInputs(event.target.value, index, "PAN");
  };

  return (
    <div>
      <p className="short-answer-p">PAN</p>
        ...
        >
          <select
            ...
            onChange={(event) => {
              ...
              setInputs(temp, index, "PAN", "responseValidation");
            }}
          >
            <option></option>
          ...
          <img
            ...
            onClick={() => {
              ...
              setInputs({}, index, "pan", "responseValidation");
            }}
          />
        </div>
      )}
