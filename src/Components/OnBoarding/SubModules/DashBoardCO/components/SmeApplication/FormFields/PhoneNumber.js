...
const PhoneNumber = ({ index, setInputs, deleteInputs, data }) => {
  ...
  const setDescription = (editorState) => {
    ...
    setInputs(htmlData, index, "phoneNumber", "description");
    setEditorState(editorState);
  };

  const setValues = (event) => {
    setTextField(event.target.value);
    setInputs(event.target.value, index, "phoneNumber");
  };

  return (
    <div>
      <p className="short-answer-p">Phone Number</p>
        ...
        >
          <select
            ...
            onChange={(event) => {
              ...
              setInputs(temp, index, "phoneNumber", "responseValidation");
            }}
          >
            <option></option>
          ...
          <img
            ...
            onClick={() => {
              ...
              setInputs({}, index, "phoneNumber", "responseValidation");
            }}
          />
        </div>
      )}
