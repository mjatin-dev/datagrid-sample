...
const Price = ({ index, setInputs, deleteInputs, data }) => {
  ...
  const setDescription = (editorState) => {
    ...
    setInputs(htmlData, index, "price", "description");
    setEditorState(editorState);
  };

  const setValues = (event) => {
    setTextField(event.target.value);
    setInputs(event.target.value, index, "price");
  };

  return (
    <div>
      <p className="short-answer-p">Price</p>
        ...
        >
          <select
            ...
            onChange={(event) => {
              ...
              setInputs(temp, index, "price", "responseValidation");
            }}
          >
            <option></option>
          ...
          >
            {responseValidation.validation === "Length" && (
              ...
              >
                <option></option>
                <option value="Maximum character count">Maximum value</option>
                <option value="Minimum character count">Minimum value</option>
              </select>
            )}
          ...
          <img
            ...
            onClick={() => {
              ...
              setInputs({}, index, "price", "responseValidation");
            }}
          />
        </div>
      )}
