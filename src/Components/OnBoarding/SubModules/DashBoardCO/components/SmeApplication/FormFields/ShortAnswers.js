...
const ShortAnswer = ({ index, setInputs, data, deleteInputs }) => {
  ...
  const setDescription = (editorState) => {
    ...
    setInputs(htmlData, index, "shortanswer", "description");
    setEditorState(editorState);
  };

  const setValues = (event) => {
    setTextField(event.target.value);
    setInputs(event.target.value, index, "shortanswer");
  };

  return (
    <div>
      <p className="short-answer-p">Short Answer</p>
        ...
        >
          <select
            ...
            onChange={(event) => {
              ...
              setInputs(temp, index, "shortanswer", "responseValidation");
            }}
          >
            <option></option>
          ...
          >
            {responseValidation.validation === "Number" && (
              <select
                className="SelectorOption"
              ...
              >
                ...
                <option value="Is number">Is number</option>
                <option value="Whole number">Whole number</option>
              </select>
            )}

            {responseValidation.validation === "Text" && (
              <select
                className="SelectorOption"
                value={responseValidation.option}
                onChange={(event) => {
            ...
            {responseValidation.option === "URL" ||
            responseValidation.option === "Email" ? null : (
              <input
                type="text"
                placeholder="Number"
          ...
          <img
            ...
            onClick={() => {
              ...
              setInputs({}, index, "shortanswer", "responseValidation");
            }}
          />
        </div>
      )}
