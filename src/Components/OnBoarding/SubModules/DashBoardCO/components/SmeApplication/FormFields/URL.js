...
const URL = ({ index, setInputs, deleteInputs,data }) => {
  ...
  const [responseValidation, setResponseValidation] = useState({
    ...
    customError: "",
     ...
     const setDescription = (editorState) => {
       ...
       setInputs(htmlData, index, "URL", "description");
       setEditorState(editorState);
     };

     const setValues = (event) => {
       setTextField(event.target.value);
       setInputs(event.target.value, index, "URL");
     };

     return (
       <div>
         <p className='short-answer-p'>URL</p>
           ...
           >
             <select
               ...
               onChange={(event) => {
                 ...
                 setInputs(temp, index, "URL", "responseValidation");
               }}
             >
               <option></option>
