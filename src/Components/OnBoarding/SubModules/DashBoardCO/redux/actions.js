...
const POST_TASK_COMMENT_SUCCESS_BY_TASK_ID = "CAPMTECH/POST_TASK_COMMENT_SUCCESS_BY_TASK_ID";
const POST_TASK_COMMENTS_FAILED_BY_TASK_ID = "CAPMTECH/POST_TASK_COMMENTS_FAILED_BY_TASK_ID";


const POST_BULK_TASK_COMMENT_BY_TASK_ID         = "CAPMTECH/POST_BULK_TASK_COMMENT_BY_TASK_ID";
const POST_BULK_TASK_COMMENT_SUCCESS_BY_TASK_ID = "CAPMTECH/POST_BULK_TASK_COMMENT_SUCCESS_BY_TASK_ID";
const POST_BULK_TASK_COMMENTS_FAILED_BY_TASK_ID = "CAPMTECH/POST_BULK_TASK_COMMENTS_FAILED_BY_TASK_ID";
...
const CHANGE_BULK_TASK_STATUS = "CAPMTECH/CHANGE_BULK_TASK_STATUS";
const CHANGE_BULK_TASK_STATUS_SUCCESS = "CAPMTECH/CHANGE_BULK_TASK_STATUS_SUCCESS";
const CHANGE_BULK_TASK_STATUS_FAILED = "CAPMTECH/CHANGE_BULK_TASK_STATUS_FAILED";


const CHANGE_BULK_TASK_ASIGN          = "CAPMTECH/CHANGE_BULK_TASK_ASIGN";
const CHANGE_BULK_TASK_ASIGN_SUCCESS  = "CAPMTECH/CHANGE_BULK_TASK_ASIGN_SUCCESS";
const CHANGE_BULK_TASK_ASIGN_FAILED   = "CAPMTECH/CHANGE_BULK_TASK_ASIGN_FAILED";

const CHANGE_BULK_TASK_MARK_COMPLETE          = "CAPMTECH/CHANGE_BULK_TASK_MARK_COMPLETE";
const CHANGE_BULK_TASK_MARK_COMPLETE_SUCCESS  = "CAPMTECH/CHANGE_BULK_TASK_MARK_COMPLETE_SUCCESS";
const CHANGE_BULK_TASK_MARK_COMPLETE_FAILED   = "CAPMTECH/CHANGE_BULK_TASK_MARK_COMPLETE_FAILED";
...
const CO_SETTING_GENERATE_OTP_REQUEST = "CO_SETTING/GENERATE_OTP_REQUEST";

const CO_SIDEBAR_MENU_OPEN_CLOSE ="CO_SIDEBAR_MENU_OPEN_CLOSE";

// Default Filers For Dev Ex Filter
const DEV_EX_FILTER_DATA = "DEV_EX_FILTER_DATA";

// Action method
const devexFilterRequest = createAction(DEV_EX_FILTER_DATA);
...
const postTaskCommentByTaskIDSuccess = createAction(POST_TASK_COMMENT_SUCCESS_BY_TASK_ID);
const postTaskCommentByTaskIDFailed   = createAction(POST_TASK_COMMENTS_FAILED_BY_TASK_ID);



const postBulkTaskCommentByTaskID         = createAction(POST_BULK_TASK_COMMENT_BY_TASK_ID);
const postBulkTaskCommentByTaskIDSuccess  = createAction(POST_BULK_TASK_COMMENT_SUCCESS_BY_TASK_ID);
const postBulkTaskCommentByTaskIDFailed   = createAction(POST_BULK_TASK_COMMENTS_FAILED_BY_TASK_ID);
...
const changeBulkTaskStatusRequest = createAction(CHANGE_BULK_TASK_STATUS);
const changeBulkTaskStatusSuccess = createAction(CHANGE_BULK_TASK_STATUS_SUCCESS);
const changeBulkTaskStatusFailed  = createAction(CHANGE_BULK_TASK_STATUS_FAILED);

const changeBulkTaskAsignRequest = createAction(CHANGE_BULK_TASK_ASIGN);
const changeBulkTaskAsignSuccess = createAction(CHANGE_BULK_TASK_ASIGN_SUCCESS);
const changeBulkTaskAsignFailed  = createAction(CHANGE_BULK_TASK_ASIGN_FAILED);

const changeBulkTaskMarkCompleteRequest = createAction(CHANGE_BULK_TASK_MARK_COMPLETE);
const changeBulkTaskMarkCompleteSuccess = createAction(CHANGE_BULK_TASK_MARK_COMPLETE_SUCCESS);
const changeBulkTaskMarkCompleteFailed  = createAction(CHANGE_BULK_TASK_MARK_COMPLETE_FAILED);
...
const generateOtp = createAction(CO_SETTING_GENERATE_OTP_REQUEST);
const coSettingSideBarOpen = createAction(CO_SIDEBAR_MENU_OPEN_CLOSE);
export const actions = {
  ...
  postBulkTaskCommentByTaskID,
  postBulkTaskCommentByTaskIDSuccess,
  postBulkTaskCommentByTaskIDFailed,

  changeTaskStatusRequest,
  changeTaskStatusSuccess,
  changeTaskStatusFailed,

  changeBulkTaskStatusRequest,
  changeBulkTaskStatusSuccess,
  changeBulkTaskStatusFailed,

  changeBulkTaskAsignRequest,
  changeBulkTaskAsignSuccess,
  changeBulkTaskAsignFailed,

  changeBulkTaskMarkCompleteRequest,
  changeBulkTaskMarkCompleteSuccess,
  changeBulkTaskMarkCompleteFailed,
...
export const types = {
  ...
  POST_BULK_TASK_COMMENT_BY_TASK_ID,
  POST_BULK_TASK_COMMENT_SUCCESS_BY_TASK_ID,
  POST_BULK_TASK_COMMENTS_FAILED_BY_TASK_ID,
  ...
  CHANGE_BULK_TASK_STATUS,
  CHANGE_BULK_TASK_STATUS_SUCCESS,
  CHANGE_BULK_TASK_STATUS_FAILED,

  CHANGE_BULK_TASK_MARK_COMPLETE,
  CHANGE_BULK_TASK_MARK_COMPLETE_SUCCESS,
  CHANGE_BULK_TASK_MARK_COMPLETE_FAILED,

  CHANGE_BULK_TASK_ASIGN,
  CHANGE_BULK_TASK_ASIGN_SUCCESS,
  CHANGE_BULK_TASK_ASIGN_FAILED,
  ...
  CO_SET_LOADER,
  CO_SETTING_GENERATE_OTP_REQUEST,
  CO_SIDEBAR_MENU_OPEN_CLOSE
};
