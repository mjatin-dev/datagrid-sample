...
export const GET_TRASH_TASKS_LIST_REQUEST = "GET_TRASH_TASKS_LIST_REQUEST";
export const GET_TRASH_TASKS_LIST_SUCCESS = "GET_TRASH_TASKS_LIST_SUCCESS";
export const GET_TRASH_TASKS_LIST_FAILED = "GET_TRASH_TASKS_LIST_FAILED";
...
// Project and Task Loader
export const CREATE_PROJECT_LOADER = "CREATE_PROJECT_LOADER";
export const CREATE_TASK_LOADER = "CREATE_TASK_LOADER";
...
// loader Action 
export const setCreateProjectLoader = (payload) => {
  return {
    type : CREATE_PROJECT_LOADER,
    payload,
  }
}
export const setCreateTaskLoader = (payload) => {
  return {
    type : CREATE_TASK_LOADER,
    payload,
  }
}
...
export const getTrashTaskListRequest = createAction(
  GET_TRASH_TASKS_LIST_REQUEST
);
export const getTrashTaskListSuccess = createAction(
  GET_TRASH_TASKS_LIST_SUCCESS
);
export const getTrashTaskListFailed = createAction(GET_TRASH_TASKS_LIST_FAILED);
