...
const actionHandlers = {
  ...
  [GET_TRASH_TASKS_LIST_REQUEST]: (state) => ({
    ...state,
    projectManagementTrash: {
      ...state?.projectManagementTrash,
      isLoading: true,
      isError: false,
      trashTaskList: [...state?.projectManagementTrash?.trashTasks],
    },
  }),
  [GET_TRASH_TASKS_LIST_SUCCESS]: (state, { payload }) => ({
    ...state,
    projectManagementTrash: {
      ...state?.projectManagementTrash,
      isLoading: false,
      isError: false,
      trashTaskList: [...payload],
    },
  }),
  [GET_TRASH_TASKS_LIST_FAILED]: (state) => ({
    ...state,
    projectManagementTrash: {
      ...state?.projectManagementTrash,
      isLoading: false,
  ...
  [CREATE_PROJECT_LOADER]: (state, { payload }) => ({
    ...state,
    ProjectLoader: payload,
  }),
  [CREATE_TASK_LOADER]: (state, { payload }) => ({
    ...state,
    TaskLoader: payload,
  }),
};
